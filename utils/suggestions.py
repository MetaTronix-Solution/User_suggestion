...
# ✅ FIX 2: backend kwarg only exists in sentence-transformers>=2.3.0
#    Render ships an older version, so we just skip it entirely.
#    The L3 model swap is the main RAM win anyway.
